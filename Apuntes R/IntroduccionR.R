...
# setwd("ruta")
# Archivo / Herramientas -> Cambiar Dir
...
####	PONER CONDICIONES: IF ELSE IFELSE
if(4 > 5) {
  "Verdadero"
} else {
  "Falso"
...
download.file(
  url = "https://raw.githubusercontent.com/jboscomendoza/r-principiantes-bookdown/master/datos/breast-cancer-wis.data", dest = "breast-cancer-wis.data")
